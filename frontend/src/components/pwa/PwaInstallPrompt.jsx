...
export default function PwaInstallPrompt() {
  ...
  return (
    <div
      className="fixed bottom-4 left-4 right-4 z-[120] mx-auto max-w-lg rounded-2xl border border-slate-200 bg-white p-4 shadow-2xl dark:border-white/10 dark:bg-slate-900 sm:bottom-6 sm:left-6 sm:right-auto"
      role="dialog"
