/** Taqqoslash ustunlari — MyUni rang palitrasi. */
export const COMPARE_SLOT_THEMES = [
  {
    ring: "ring-primary/40",
    accent: "border-primary",
    headerGradient: "from-primary/80 via-[#0f2744]/95 to-slate-950",
    headerGlow: "shadow-lg shadow-primary/20",
    bar: "bg-primary",
  ...
  },
  {
    ...
    headerGradient: "from-violet-600/75 via-[#1a1033]/95 to-slate-950",
    headerGlow: "shadow-lg shadow-violet-500/15",
    bar: "bg-violet-500",
  ...
  },
  {
    ...
    headerGradient: "from-emerald-600/70 via-[#0a1f1a]/95 to-slate-950",
    headerGlow: "shadow-lg shadow-emerald-500/15",
    bar: "bg-emerald-500",
