...
export default function ReviewAuthPromptModal({ open, onClose, signupTo, loginTo, universityName }) {
  ...
  return createPortal(
    <ModalOverlay
      onClose={onClose}
      labelledBy="review-auth-modal-title"
      zIndexClass="z-[250]"
      panelClassName="w-full max-w-md rounded-[2rem] border border-slate-200 bg-white p-6 shadow-2xl dark:border-white/10 dark:bg-slate-900 sm:p-8"
    >
