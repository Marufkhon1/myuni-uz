...
export function getCompareContent(isStudent) {
  if (isStudent) {
    return {
      ...
      subtitle:
        "2–4 ta universitetni yonma-yon jadvalda ko'ring — reyting, sharhlar, chat va talaba baholari.",
      myUniversityLabel: "Mening universitetimni qo'shish",
      maxLabel: "2–4 ta OTM tanlang — kamida 2 ta bo'lsa natija chiqadi (maks. 4)",
      pickerHint: "Ro'yxatdan tanlang — avtomatik bo'sh slotga qo'shiladi",
      quickPickLabel: "Tez tanlash",
      emptyHint: "Taqqoslash uchun kamida 2 ta turli universitet tanlang.",
  ...
  return {
    ...
    subtitle: "2–4 ta universitetni bir jadvalda solishtirib, tanlovingizni osonlashtiring.",
    myUniversityLabel: "Qiziqishimni qo'shish",
    maxLabel: "2–4 ta OTM tanlang — kamida 2 ta bo'lsa natija chiqadi (maks. 4)",
    pickerHint: "Qidiruv orqali qo'shing — bir xil OTM ikki marta qo'shilmaydi",
    quickPickLabel: "Mashhur kombinatsiyalar",
    emptyHint: "Taqqoslash uchun kamida 2 ta universitet tanlang.",
...
export const COMPARE_METRICS = [
  ...
  {
    key: "tuition_primary_average_uzs",
    label: "Kontrakt (taxmin)",
    icon: "💰",
    format: (value) =>
      value != null ? `${new Intl.NumberFormat("uz-UZ").format(Math.round(Number(value)))} so'm` : "—",
    bar: true,
    higherIsBetter: false,
    hint: "MyUni hisob-kitobi; rasmiy narx-noma emas",
  },
  {
...
export const PUBLIC_COMPARE_CONTENT = {
  ...
  subtitle: "2–4 ta OTM yonma-yon. Ulashilgan havola 2 kun amal qiladi.",
  verdictTitle: "Umumiy natija",
  metricsTitle: "Ko'rsatkich",
  aspectsTitle: "Talabalar baholari",
  detailsTitle: "Har bir OTM batafsil",
